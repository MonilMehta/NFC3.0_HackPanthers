...
const Model = ({ onHover }) => {
  const { scene } = useGLTF('/volunteer.glb'); // Ensure the path is correct
  return (
    <primitive 
      object={scene} 
      scale={1} 
...
const RotationVol = () => {
  ...
  return (
    <div style={{ width: '300px', height: '300px', background: '#ffffff', margin: 'auto', }}>
